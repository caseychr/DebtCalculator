...
public class SnowballDebtCalculator_Tests
{
    ...
    public void setup()
    {
        ...
        SnowballCalculate.getSnowballCalculateEntries().clear();
        Calculate.setTotalAmountPaid(0);
    }

    @Test
    public void entriesAreOrderedByPrinciple()
    {
        String fileName = "C:\\Users\\mcasey\\IdeaProjects\\DebtCalculator\\src\\Tests\\fourEntries.csv";
        Entry testEntry_2 = new Entry(532.15, 32.05, .068);
        Entry testEntry_4 = new Entry(40540.53, 1004.45, .05);
        Entry testEntry_3 = new Entry(1253.02, 43.04, .04);
        Entry testEntry_1 = new Entry(85.44, 12.32, .06);
    ...
    public void oneEntryIsCalculatedWithCalculator_NoInterest()
    {
        ...
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_1);

        SnowballCalculate.calculate();
    ...
    public void twoEntriesIsCalculatedWithCalculator_NoInterest()
    {
        ...
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_1);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_2);
    ...
    public void eightEntriesIsCalculatedWithCalculator_NoInterest()
    {
        ...
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_1);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_2);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_3);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_4);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_5);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_6);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_7);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_8);
    ...
    public void eightEntriesIsCalculatedWithCalculator_NoInterest_UnevenMinimumPayment()
    {
        ...
        for(Entry entry:SnowballCalculate.getSnowballCalculateEntries())
    ...
    public void twentyEntriesIsCalculatedWithCalculator_NoInterest()
    {
        ...
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_7);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_8);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_9);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_10);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_11);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_12);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_13);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_14);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_15);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_16);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_17);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_18);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_19);
        SnowballCalculate.getSnowballCalculateEntries().add(testEntry_20);
    ...
    public void retrieveDebtPayOffEndDate()
    {
        ...
        String endDate = Calculate.getTotalDebtPayoffEndDate(SnowballCalculate.getSnowballCalculateEntries());
